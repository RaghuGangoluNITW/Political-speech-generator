...
export const TEST_TEMPLATES = [
  {
    ...
    template: {
      ...
      "speech-length": "3000 words (approximately 20 minutes)",
  ...
  },
  {
    ...
    template: {
      ...
      "speech-length": "3000 words (approximately 30 minutes)",
  ...
  template: {
    ...
    "speech-length": "3000 words (approximately 18-20 minutes)",
...
},
{
  ...
  template: {
    ...
    "speech-length": "3000 words (approximately 15–18 minutes)",
...
//     "speech-length": "2000-2500 words (approximately 12–15 minutes)",
...
{
  id: 6,
  name: "Independence Day Speech Template",
  description: "A patriotic and inspiring template designed to honor India's independence, celebrate national achievements, and inspire unity among citizens on this historic day.",
  thumbnail: "independence_day.jpg",
  template: {
    // Candidate Profile
    "candidate-name": "Shri Gadde Rammohan Rao",
    "political-party": "Telugu Desam Party (TDP)",
    "office-sought": "Member of Legislative Assembly (MLA), Vijayawada",
    "brief-bio": "Gadde Rammohan Rao is a respected leader from Vijayawada, recognized for his deep commitment to public service, community development, and transparent governance. Having served as MLA and in key municipal roles, he has championed initiatives in education, infrastructure, and healthcare, while fostering civic pride and social responsibility.",
    "key-strengths": "Education, Healthcare, Technology, Infrastructure, Housing",

    // Audience Profile
    "age-range": "25-65",
    "occupation": "Students, Teachers, Farmers, Government employees, Private sector workers, Senior citizens",
    "interests": "Patriotism, Development, Social harmony, Education, Cultural heritage",
    "education-level": "Mixed Education Levels",
    "socioeconomic-status": "Lower to upper-middle class",
    "cultural-background": "Urban and semi-urban Telugu-speaking communities with strong Indian cultural values",
    "political-affiliation": "Mixed/Various",
    "affiliation-strength": "Moderate",
    "primary-concerns": "National unity, economic growth, employment opportunities, cultural preservation, civic pride",
    "existing-values": "Patriotism, Democracy, Self-reliance, Respect for freedom fighters, Community service",

    // Speech Parameters
    "speech-type": "Independence Day Speech",
    "primary-objective": "To inspire pride, unity, and civic responsibility among the people of Vijayawada while commemorating India's Independence Day.",
    "secondary-objective": "To highlight India's progress, acknowledge sacrifices made for freedom, and motivate citizens to contribute to nation-building.",
    "slogan": "United We Stand, Proud We Progress",
    "main-message": "Today, as we celebrate the 79th Independence Day, we remember the sacrifices of our freedom fighters, honor our national spirit, and reaffirm our commitment to building a stronger, united, and self-reliant India.",
    "policy-points": "#. Strengthening educational initiatives to empower youth with knowledge and values.\n#. Expanding skill development programs to create employment opportunities.\n#. Promoting sustainable urban development in Vijayawada.\n#. Enhancing healthcare access and sanitation for all citizens.\n#. Supporting local entrepreneurs and farmers for economic self-reliance.\n#. Encouraging cultural programs to preserve our heritage.\n#. Launching civic participation drives to involve citizens in governance.",
    "key-messages": "Freedom is not just a gift — it is a responsibility.\nEvery citizen is a stakeholder in India's progress.\nUnity in diversity is our greatest strength.\nOur heroes fought for a dream — it is our duty to realize it.\nThe future of our nation lies in the hands of responsible and proactive citizens.",
    "personal-story": "I still remember my first Independence Day celebration as a schoolboy in Vijayawada. Holding the tricolor in my hand and singing the national anthem filled me with pride. That day, I promised myself that I would serve this land and its people in every way I could.",
    "anecdote": "Last week, I met a young girl from Krishnalanka who recited a poem about our freedom fighters. Her words reminded me that the torch of patriotism burns brightest in the hearts of our youth — and it is our job to keep that flame alive.",
    "hypothetical-scenario": "Imagine an India where every child goes to school without worry, every youth finds meaningful work, and every citizen feels safe and respected. Imagine Vijayawada as a model constituency leading this vision — a place where development meets tradition and unity drives progress.",
    "call-to-action": "Multiple Actions",
    "cta-instructions": "Take a pledge today to contribute at least one hour a week to community service.\nTeach the younger generation about our freedom struggle.\nSupport local businesses and farmers.\nStay informed and participate in local governance meetings.\nFollow verified government and MLA updates for civic initiatives.",
    "speech-tone": "Inspirational",
    "formality": "Formal",
    "emotional-appeal": "High",
    "humor": "Absent (due to solemnity and respect of occasion)",
    "rhetorical-devices": "Alliteration, Anaphora, Parallelism, Metaphor, Tricolon, Historical Reference, Personification",
    "speech-length": "3000 words (approximately 30 minutes)",
    "political-climate": "Patriotic unity across party lines, focus on national development and communal harmony.",
    "recent-events": "India's advancements in technology, successful space missions, infrastructure growth, and renewed focus on 'Atmanirbhar Bharat' (self-reliant India).",
    "campaign-stage": "Post-Election",
