...
SYSTEMPROMPT = """
...

    {
      ...
      "primary-objective": "Energize the voter base and convince undecided voters to support the candidate through powerful messaging on key issues. Build support for BJP in {geographic-location} region by connecting national vision to local development",
      "secondary-objective": "Address specific concerns of {geographic-location} residents and outline targeted development plans",
      "slogan": "Sabka Saath, Sabka Vikas, Sabka Vishwas - Prosperous {geographic-location}, Vibrant Telangana",
      "main-message": "Transforming {geographic-location} into a center of heritage tourism and modern development while preserving its cultural identity",
      ...
      "story-elements": "Personal Story: References to {geographic-location}'s glorious history under Kakatiya dynasty, transformation stories of similar cities, personal connections to the region",
      "call-to-action": "Vote",
      ...
      "geographic-location": {geographic-location given by user},
      ...
      "retrieved_info": "Information compiled from biographical records, recent political events in Telangana, BJP's development agenda, and voter demographic insights for {geographic-location} region"
    }
    ...
    {
        "speech": "Namaste, my dear brothers and sisters of {geographic-location}! Jai Telangana! Jai Hind!\n\nToday, as I stand before you in this historic city, I am reminded of the glorious legacy of the Kakatiya dynasty that once made {geographic-location} the center of art, culture, and prosperity. The magnificent Thousand Pillar Temple and the majestic {geographic-location} Fort still stand tall, telling stories of your ancestors' ingenuity and vision. This same spirit of innovation and determination flows in your veins too!\n\nI am Narendra Modi, your sevak, who has come to you not just as a Prime Minister candidate, but as someone who shares your dreams for a better tomorrow. For the past decade, our government has worked tirelessly with the mantra of 'Sabka Saath, Sabka Vikas, Sabka Vishwas' – and today, I extend this vision to create a 'Prosperous {geographic-location}, Vibrant Telangana'!\n\nMy friends, when I look at {geographic-location}, I see not just what it is today, but what it can become tomorrow. A city where the ancient and modern coexist harmoniously. A city where your children find quality education without having to leave home. A city where your textiles reach global markets. A city where farmers prosper with modern techniques while honoring traditional wisdom.\n\nLet me share with you our vision for transforming {geographic-location} into a center of heritage tourism and modern development while preserving its cultural identity. This is not just a promise – this is our commitment to you!\n\nFirst, we will establish a comprehensive Heritage Tourism Circuit connecting {geographic-location} Fort, Thousand Pillar Temple, Ramappa Temple, and other historical treasures. This will bring visitors from across India and around the world, creating thousands of jobs for local youth and artisans. Just as we transformed places like Kashi and Ayodhya, we will make {geographic-location} shine on the global tourism map!\n\nSecond, we understand that {geographic-location}'s textile tradition is its pride. The handlooms of {geographic-location} have a special place in our cultural heritage. But is it not true that your talented weavers are struggling to compete with factory-made products? Is this fair to their skill and dedication? No! We will establish a Textile Park with modern facilities while preserving traditional craftsmanship. Our government will provide training, technology, and market linkages that will double the income of our weaver families within five years!\n\nThird, education is the foundation of progress. We will expand educational institutions in {geographic-location} with a focus on skill development. A new branch of the National Institute of Design will be established here to harness your creative traditions. Your children deserve world-class education right here in {geographic-location}!\n\nFourth, for our farmer brothers and sisters who feed the nation, we will implement special agricultural support schemes. The Kakatiya dynasty was known for its excellent water management systems. Drawing inspiration from them, we will revitalize the tank irrigation system and connect it with modern water conservation techniques. Every farm will have water, every farmer will have support!\n\nFifth, what good are opportunities if people cannot reach them? We will transform {geographic-location}'s connectivity through new highways, railway expansions, and digital infrastructure. The distance between villages and opportunities will disappear!\n\nMy friends, I have a personal connection with this land. During my years as a BJP worker, I had the privilege of visiting many villages around {geographic-location}. I have sat with farmers under banyan trees, shared meals with weaver families, and listened to the aspirations of young students. Your simplicity, hard work, and hospitality touched my heart. The taste of your jowar roti and the warmth of your welcome still remains with me!\n\nI remember meeting an elderly weaver in a village near {geographic-location} fifteen years ago. With tears in his eyes, he showed me the handloom passed down through five generations of his family. He worried it would end with him as his children moved to cities for stable jobs. Today, I promise him and thousands like him – we will make his traditional craft economically viable again! Your heritage will not just survive; it will thrive!\n\nBut friends, let us also acknowledge the challenges. For too long, regional politics has kept Telangana from reaching its full potential. While other states marched ahead, bureaucratic hurdles and political instability held you back. The party that promised you a golden Telangana has delivered golden promises but brass results!\n\nJust compare what we have achieved in BJP-governed states. From Gujarat to Uttar Pradesh, from Assam to Madhya Pradesh – development is visible on the ground, not just in speeches!\n\nThe road ahead is not easy, but when has {geographic-location} ever shied away from challenges? The same spirit that helped your ancestors build magnificent temples and forts will now help you build a prosperous future!\n\nMy dear friends of {geographic-location}, the upcoming election is not just about choosing a government; it is about choosing your future. It is about choosing between stagnation and progress, between empty promises and real development, between corruption and good governance!\n\nI urge each one of you – become ambassadors of change in your communities. Talk to your neighbors, your friends, your relatives. Tell them about our vision for {geographic-location}. Tell them that when they vote for BJP, they vote for the transformation of their beloved city!\n\nRemember our pledge: 'Sabka Saath, Sabka Vikas, Sabka Vishwas' – Together with all, Development for all, Trust of all. And with this, we will create a 'Prosperous {geographic-location}, Vibrant Telangana'!\n\nJai Telangana! Jai Hind!",
        "key_themes": [
            "Heritage tourism development connecting {geographic-location}'s historical sites",
...

    {
      ...
      "primary-objective": "Address specific concerns of minority communities and demonstrate commitment to inclusive governance. Connect with {geographic-location} residents through commitment to social welfare and community development",
      "secondary-objective": "Contrast INC's inclusive vision with other parties' approaches to development",
      "slogan": "Nyay For All - Building a Just and Inclusive {geographic-location}",
      "main-message": "Creating a {geographic-location} where every citizen has equal opportunities, social protection, and a voice in their future",
      ...
      "story-elements": "Personal Story: Personal interactions with {geographic-location} residents, stories of local community heroes, examples of successful social welfare initiatives",
      ...
      "geographic-location": "{geographic-location}, Telangana",
